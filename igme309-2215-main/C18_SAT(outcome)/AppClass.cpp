...
void Application::InitVariables(void)
{
	...
	m_v3Creeper = vector3(2.5f, 1.0f, 0.1f); //position of the creeper
...
void Application::Update(void)
{
	...
	matrix4 m4Creeper =
		glm::translate(m_v3Creeper) * 
		ToMatrix4(m_qArcBall) *
		glm::rotate(glm::radians(45.0f), vector3(1.0f));
	...
	matrix4 m4Steve = 
		glm::translate(vector3(2.25f, 0.0f, 0.0f)) * 
		glm::rotate(glm::radians(45.0f), vector3(-1.0f));
