...
{
	m_pFolder = FolderSingleton::GetInstance();
...
void SystemSingleton::SetWindowResolution(uint a_nResolution)
{
	...
	{
	case eBTX_RESOLUTIONS::RES_C_720x480_4x3_NTSC:
		m_nWindowWidth = 720;
		m_nWindowHeight = 480;
		break;
	case eBTX_RESOLUTIONS::RES_C_1280x720_16x9_HD:
		m_nWindowWidth = 1280;
		m_nWindowHeight = 720;
		break;
	case eBTX_RESOLUTIONS::RES_C_1920x1080_16x9_FULLHD:
		m_nWindowWidth = 1920;
		m_nWindowHeight = 1080;
		break;
	case eBTX_RESOLUTIONS::RES_M_640x480_4x3_VGA:
		m_nWindowWidth = 640;
		m_nWindowHeight = 480;
		break;
	case eBTX_RESOLUTIONS::RES_M_1600x900_16x9_WXGA:
		m_nWindowWidth = 1600;
		m_nWindowHeight = 900;
		break;
	case eBTX_RESOLUTIONS::RES_M_1920x1200_16x10_WUXGA:
		m_nWindowWidth = 1920;
		m_nWindowHeight = 1200;
		break;
	case eBTX_RESOLUTIONS::RES_M_2560x1080_21x9_UWUXGA:
		m_nWindowWidth = 2560;
		m_nWindowHeight = 1080;
		break;
	case eBTX_RESOLUTIONS::RES_O_800x600_4x3_SVGA:
		m_nWindowWidth = 800;
		m_nWindowHeight = 600;
		break;
	case eBTX_RESOLUTIONS::RES_O_1024x768_4x3_XGA:
		m_nWindowWidth = 1024;
		m_nWindowHeight = 768;
		break;
	case eBTX_RESOLUTIONS::RES_O_1280x800_16x10_WXGA:
		m_nWindowWidth = 1280;
		m_nWindowHeight = 800;
		break;
	case eBTX_RESOLUTIONS::RES_O_1600x1200_4x3_UXGA:
		m_nWindowWidth = 1600;
		m_nWindowHeight = 1200;
		break;
	case eBTX_RESOLUTIONS::RES_O_2048x1080_17x9_2K:
		m_nWindowWidth = 2048;
		m_nWindowHeight = 1080;
		break;
	case eBTX_RESOLUTIONS::RES_O_3840x2160_17x9_4K:
		m_nWindowWidth = 3480;
		m_nWindowHeight = 2160;
		break;
	case eBTX_RESOLUTIONS::RES_CV_480x720_3x4_NTSC:
		m_nWindowWidth = 480;
		m_nWindowHeight = 720;
		break;
	case eBTX_RESOLUTIONS::RES_CV_720x1280_9x16_HD:
		m_nWindowWidth = 720;
		m_nWindowHeight = 1280;
		break;
	case eBTX_RESOLUTIONS::RES_CV_1080x1920_9x16_FULLHD:
		m_nWindowWidth = 1080;
		m_nWindowHeight = 1920;
		break;
	case eBTX_RESOLUTIONS::RES_MV_480x640_3x4_VGA:
		m_nWindowWidth = 480;
		m_nWindowHeight = 640;
		break;
	case eBTX_RESOLUTIONS::RES_MV_900x1600_9x16_WXGA:
		m_nWindowWidth = 900;
		m_nWindowHeight = 1600;
		break;
	case eBTX_RESOLUTIONS::RES_MV_1200x1920_10x16_WUXGA:
		m_nWindowWidth = 1200;
		m_nWindowHeight = 1920;
		break;
	case eBTX_RESOLUTIONS::RES_MV_1080x2560_9x21_UWUXGA:
		m_nWindowWidth = 1080;
