...
public:
	...
	*/
	eBTX_OUTPUT LoadDiffuse(String a_sFileName);
	...
	OUTPUT: Success flags
	*/
	eBTX_OUTPUT LoadNormal(String a_sFileName);
	...
	OUTPUT: Success flags
	*/
	eBTX_OUTPUT LoadSpecular(String a_sFilename);
