...
Update: 2021/02
----------------------------------------------*/
#ifndef __BTXSYSTEM_H_
#define __BTXSYSTEM_H_

#include "FolderSingleton.h"

namespace BTX
{
//System Class
class BTXDLL SystemSingleton
{
	...
	String m_sWindowName = "BTX - Window"; // Window Name
	String m_sAppName = "BTX - Application";//Name of the Application
...
public:
	FolderSingleton* m_pFolder; //Folder that contains the address of resources
	...
	*/
	...
	ARGUMENTS:
	BTO_RESOLUTIONS a_Resolution = BTX_RESOLUTIONS::HD_1280X720 -> resolution of the screen
	OUTPUT: ---
	*/
	...
	*/
	...
	OUTPUT: ---
	*/
	void SetWindowResolution(uint a_nResolution = eBTX_RESOLUTIONS::RES_C_1280x720_16x9_HD);
